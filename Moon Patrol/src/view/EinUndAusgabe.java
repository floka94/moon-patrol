 ...
 * @version 2.0
 * 
 *          Diese Klasse ermï¿½glicht die Ausgabe einer Text-Basierten Grafik und
 *          gibt Tastendrï¿½cke zurï¿½ck.
 * 
 *          Die automatische Tastenwiederholung bei gedrï¿½ckt gehaltener Taste
 *          ist standardmï¿½ï¿½ig ausgeschaltet. Wird sie mit der Methode
 *          <code> typematic(boolean on) </code>eingeschaltet, dann liegt die
 *          Anschlagsverzï¿½gerung bei 20 ms. D.h. eine gedrï¿½ckt gehaltene Taste
...
public class EinUndAusgabe extends Observable {
	...
	public EinUndAusgabe(String fensterName, int fontGroesse, int zeilen, int spalten) {
		...
		frame = new JFrame(fensterName + " (Schriftgroeße: " + fontGroesse + ", Hoehe: " + zeilen + " Zeichen, Breite: "
				+ spalten + " Zeichen)");
	 ...
	 * automatische Tastenwiederholung bei gedrï¿½ckt gehaltener Taste ist
	 * standardmï¿½ï¿½ig ausgeschaltet. eingeschaltet, dann liegt die
	 * Anschlagsverzï¿½gerung bei 20 ms. D.h. eine gedrï¿½ckt gehaltene Taste
	 * liefert alle 20 ms einen Anschlag.
	 * 
	 * @param on
	...
	/**
	 * Gibt ein java.awt.event.KeyEvent (gedrï¿½ckte Taste) des Benutzers zurï¿½ck, in der
	 ...
	 * 	System.out.println("A wurde gedrï¿½ckt"); 
	 * }
	 * </code>
	 * </pre>
	 * 
	 * @return Tastendruck als Key-Event in der Reihenfolge in der sie erzeugt
	 *         wurden. null, falls keine weitere Taste gedrï¿½ckt wurde.
	 */
	...
	/**
	 * Gibt den ï¿½bergebenen String im Fenster aus. Diese Methode sollte
	 * hï¿½chstens alle 20 ms aufgerufen werden (60 Frames pro Sekunde). Alles
	 * darï¿½ber hinaus verlangsamt das Programm und bringt keinen Vorteil.
	 * 
	 * @param ausgabe
	...
	/**
	 * Gibt das ï¿½bergebene Char-Array im Fenster aus. Diese Methode sollte
	 * hï¿½chstens alle 20 ms aufgerufen werden (60 Frames pro Sekunde). Alles
	 * darï¿½ber hinaus verlangsamt das Programm und bringt keinen Vorteil.
	 * 
	 * @param ausgabe
